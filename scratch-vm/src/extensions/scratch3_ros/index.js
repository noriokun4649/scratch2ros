...
const Messages = {
    'subscribeTopic':{
        'ja':'[TOPIC] からメッセージを取得',
        'ja-Hira':'',
        'en':'Get message from [TOPIC]'
    },
    'publishTopic':{
        'ja':'[TOPIC]の[MSG]をPublish',
        'ja-Hira':'',
        'en':'Publish [MSG] to [TOPIC]'
    },
    'callService':{
        'ja':'[SERVICE]に[REQUEST]を送信',
        'ja-Hira':'',
        'en':'Send [REQUEST] to [SERVICE]'
    },
    'getParamValue':{
        'ja':'[NAME]の rosparam を取得',
        'ja-Hira':'',
        'en':'Get rosparam [NAME]'
    },
    'setParamValue':{
        'ja':'[NAME]を[VALUE]の rosparam にする',
        'ja-Hira':'',
        'en':'Set rosparam [NAME] to [VALUE]'
    },
    'getSlot':{
        'ja':'[OBJECT]から[SLOT]を取得',
        'ja-Hira':'',
        'en':'Get [OBJECT] [SLOT]'
    },
    'setSlot':{
        'ja':'Set [VAR] [SLOT] to [VALUE]',
        'ja-Hira':'Set [VAR] [SLOT] to [VALUE]',
        'en':'Set [VAR] [SLOT] to [VALUE]'
    },
    'showVariable':{
        'ja':'Show [VAR] [SLOT]',
        'ja-Hira':'Show [VAR] [SLOT]',
        'en':'Show [VAR] [SLOT]'
    },
    'hideVariable':{
        'ja':'Hide [VAR] [SLOT]',
        'ja-Hira':'Hide [VAR] [SLOT]',
        'en':'Hide [VAR] [SLOT]'
    },
    'solveFormula':{
        'ja':'[EXPRESSION] binding [OBJECT]',
        'ja-Hira':'[EXPRESSION] binding [OBJECT]',
        'en':'[EXPRESSION] binding [OBJECT]'
    }
} 
            ...
            blocks: [
                {
                    ...
                    text: Messages.subscribeTopic[this.locale],
                    arguments: {
                        TOPIC: topicArg
                    }
                },
                {
                    ...
                    text: Messages.publishTopic[this.locale],
                    arguments: {
                        MSG: variableArg,
                        TOPIC: topicArg
                    }
                ...
                '---',
                {
                    opcode: 'callService',
                    blockType: BlockType.REPORTER,
                    text: Messages.callService[this.locale],
                    arguments: {
                        REQUEST: variableArg,
                        SERVICE: serviceArg
                    }
                ...
                '---',
                {
                    ...
                    blockType: BlockType.REPORTER,
                    text: Messages.getParamValue[this.locale],
                    arguments: {
                        NAME: paramArg
                    }
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: Messages.setParamValue[this.locale],
                    arguments: {
                        NAME: paramArg,
                        VALUE: stringArg(0)
                    }
                ...
                '---',
                {
                    opcode: 'getSlot',
                    blockType: BlockType.REPORTER,
                    text: Messages.getSlot[this.locale],
                    arguments: {
                        OBJECT: variableArg,
                        SLOT: stringArg('data')
                    }
                },
                {
                    opcode: 'setSlot',
                    blockType: BlockType.COMMAND,
                    text: Messages.setSlot[this.locale],
                    arguments: {
                        VAR: variableArg,
                        SLOT: stringArg('data'),
                ...
                },
                {
                    opcode: 'showVariable',
                    blockType: BlockType.COMMAND,
                    text: Messages.showVariable[this.locale],
                    arguments: {
                        VAR: variableArg,
                        SLOT: stringArg('data')
                    }
                },
                {
                    opcode: 'hideVariable',
                    blockType: BlockType.COMMAND,
                    text: Messages.hideVariable[this.locale],
                    arguments: {
                        VAR: variableArg,
                        SLOT: stringArg('data')
                    }
                ...
                '---',
                {
                    opcode: 'solveFormula',
                    blockType: BlockType.REPORTER,
                    text: Messages.solveFormula[this.locale],
                    arguments: {
